...
export const CheckboxFiltersGroup: React.FC<Props> = ({ title,
  ...
  defaultValue, }) => 
  {
    ...
    const onChahgeSearchInput = (value: string)=> {
  ...
  return <div className={className}>
    ...
    {showAll && (
        <div className="mb-5">
          <Input onChange={e=>onChahgeSearchInput(e.target.value)} placeholder={searchInputPlaceholder} className="bg-gray-50 border-none" />
        </div>
      )}
